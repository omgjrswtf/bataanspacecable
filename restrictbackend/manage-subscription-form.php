...
$id = $_GET['id'];
$subscription = $subscriptioncon->subsBundledata($id);
...
<body>
    ...
    ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Schedule Date</h1>
                </div>
                ...
                Schedule Info:
                <hr>
                <form class="login100-form validate-form" method="POST" action="manage-subscription-form-action.php?action=atupdate&id=<?php echo $id; ?>">
                <input type="hidden" name="id" value="<?php echo $admin->adminid ?>">

                <p>Name: <?php echo $subscription->username; ?></p>
                <p>Contact: <?php echo $subscription->usercontact; ?></p>
