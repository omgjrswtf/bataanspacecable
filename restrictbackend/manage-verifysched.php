...
<body>
    ...
    ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <table class="table table-hover" id="verifyscheduleaccepts">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Client</th>
                ...
                <table class="table table-hover" id="verifyscheduleongoings">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Client</th>
    ...
    $(document).ready( function () {
        $('#verifyschedulescheds').DataTable();
        $('#verifyscheduleaccepts').DataTable();
        $('#verifyscheduleongoings').DataTable();
    } );
    </script>
