        ...
        <div class="header-inner container">
          <div class="row">
            <div class="col-md-8">
              ...
              <button onclick="history.go(-1);" style="float: right; margin-top: -25px; color: white;" class="btn btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> Back</button>
            </div>
          </div>
        </div>
      </div>
